...
<head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="./components/img/favicon.png">
        <!-- Place favicon.ico in the root directory -->

		<!-- CSS here -->
        <link rel="stylesheet" href="./components/css/bootstrap.min.css">
        <link rel="stylesheet" href="./components/css/animate.min.css">
        <link rel="stylesheet" href="./components/css/magnific-popup.css">
        <link rel="stylesheet" href="./components/css/fontawesome-all.min.css">
        ...
        <link rel="stylesheet" href="./components/css/default.css">
    ...
    <body class="theme-bg">
        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.html" class="navbar-brand logo-sticky-none"><img src="./components/img/logo/logo.png" alt="Logo"></a>
                                    <a href="index.html" class="navbar-brand s-logo-none"><img src="./components/img/logo/s_logo.png" alt="Logo"></a>
            ...
            <div class="extra-info">
                ...
                <div class="logo-side mb-30">
                    <a href="index-2.html">
                        <img src="./components/img/logo/logo.png" alt="" />
                    </a>
                </div>
        ...
        <main>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <img src="./components/img/banner/banner_img.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="banner-shape"><img src="./components/img/shape/dot_circle.png" class="rotateme" alt="img"></div>
            </section>
            <!-- banner-area-end -->
            ...
            <section id="about" class="about-area primary-bg pt-120 pb-120">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img src="./components/img/banner/banner_img2.png" title="me-01" alt="me-01">
                            </div>
                        </div>
            ...
            <section id="service" class="services-area pt-120 pb-50">
				<div class="container">
                    ...
                    <?php foreach($select_query as $services): ?>

						<div class="col-lg-4 col-md-6">
							<div class="icon_box_01 wow fadeInLeft" data-wow-delay="0.2s">
                                <i class="<?=$services['service_icon']?>"></i>
								<h3><?=$services['service_header']?></h3>
                        ...
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img src="./components/img/images/1.jpg" alt="img">
								</div>
                            ...
                            <div class="testimonial-active">
                                ...
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img src="./components/img/images/testi_avatar.png" alt="img">
                                    </div>
                    ...
                    <div class="row brand-active">
                        ...
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="./components/img/brand/brand_img01.png" alt="img">
                            </div>
                        </div>
        ...
        <script src="./components/js/isotope.pkgd.min.js"></script>
        <script src="./components/js/one-page-nav-min.js"></script>
        <script src="./components/js/slick.min.js"></script>
        <script src="./components/js/ajax-form.js"></script>
        ...
        <script src="./components/js/jquery.counterup.min.js"></script>
        <script src="./components/js/jquery.scrollUp.min.js"></script>
        <script src="./components/js/imagesloaded.pkgd.min.js"></script>
