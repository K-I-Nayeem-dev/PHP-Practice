...
if (!isset($_SESSION['dash_email'])) {
    header('location: ../signup.php');
    $_SESSION['dashboard_login_message'] = "Please Signup to Log in Dashboard";
}
            ...
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        ...
                        <span class="user-info-text" style="font-size: 11px;"><?= $_SESSION['assoc_name'] ?><br><span class="user-state-info" style="font-size: 11px; color: red"><?= $_SESSION['dash_email'] ?></span></span>
                    </a>
                </div>
            </div>
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="active-page">
                        <a href="user.php" class="active"><i class="material-icons-two-tone">people_alt</i>User</a>
                    </li>
                    <li>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
                                    <h1>Dashboard</h1>
                                    <h5>Welcome : <?= $_SESSION['assoc_name'] ?></h5>
                                    <h5>Your Email : <?= $_SESSION['dash_email'] ?></h5>
                            ...
                            <div class="col-xl-6">
                                <div class="card widget widget-list"  style="overflow-y: scroll; height: 464px;">
                                    <div class="card-header">
                                        ...
                                        $total_count = "SELECT COUNT(*) 'result' FROM users";

                                        $total_query = mysqli_query($db_connect, $total_count);

                                        $total_assoc = mysqli_fetch_assoc($total_query)['result'];
                                        
                                        ?>

                                        <h5 class="card-title">Active Tasks<span class="badge badge-success badge-style-light" style="padding-bottom: 8px;"><?php echo 'Total Number Of User '; ?>
                                        <span style="font-size: 18px; color: red; margin-left: 5px;"><?php print_r($total_assoc); ?></span>
                                         </span></h5>
                                    </div>
                                    <div class="card-body">
                                        <?php 

                                        $dash_data_entry = "SELECT ID, Name, Email FROM users";

                                        $dash_data_qu = mysqli_query($db_connect, $dash_data_entry);

                                        // $dash_asso = mysqli_fetch_assoc($dash_data_qu);
                                        ...
                                        <ul class="widget-list-content list-unstyled">
                                            ...
                                            <?php foreach ($dash_data_qu as $key  => $user) : ;?>
                                                

                                            <li class="widget-list-item widget-list-item-green">
                                                <span class="widget-list-item-icon" style="padding-top: 12px ; font-weight: bold;"> <?php print_r($key + 1)?></i></span>
                                                <span class="widget-list-item-description">
                                                    <a href="#" class="widget-list-item-description-title">
                                                        <?php print_r($user['Name']) ?>
                                                    </a>
                                                    <span class="widget-list-item-description-subtitle text-danger" style="font-size: 12px;">
                                                    <?php print_r($user['Email']) ?>
                                                    </span>
                                                </span>
                                                <form action="delete.php" method="post">
                                                    <input class="d-none" type="text" name="delete_email" value="">
