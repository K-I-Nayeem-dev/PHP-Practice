...
<body>
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <?php if (isset($_SESSION['dash_user'])) : ?>
            ...
            <form action="signup_post.php" method="post">
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="email" class="form-control m-b-md" placeholder="Enter E-mail" name="email" value="<?php

                                                                                                                    if (isset($_SESSION['sign_email'])) {

                                                                                                                        echo $_SESSION['sign_email'];
                                                                                                                    }
                    ...
                    <?php if (isset($_SESSION['preg_match_password'])) : ?>

                        <div class="alert alert-danger">

                            <?= $_SESSION['preg_match_password']; ?>
