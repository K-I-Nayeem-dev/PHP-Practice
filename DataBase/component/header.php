...
if(!isset($_SESSION['login_s_email'])){
    $_SESSION['dash_user'] = 'Plz SignUp to Login Dashboard !!!';
            ...
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        ...
                        <span class="user-info-text"><?= $_SESSION['assoc_name']; ?><br><span class="user-state-info"><?= $_SESSION['login_s_email'] ?></span></span>
                    </a>
                </div>
            </div>
            <div class="app-menu">
