        ...
        <div class="app-auth-container">
            ...
            <form action="signin_post.php" method="post">
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="email" class="form-control m-b-md" name="email" placeholder="example@neptune.com" value="<?php
                    ...
                    <input type="password" class="form-control m-b-md" name="password" placeholder="Password">
