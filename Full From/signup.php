    ...
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <form action="signup_post.php" method="post">
                ...
                <div class="auth-credentials m-b-xxl">
                    <label for="signUpUsername" class="form-label">E-mail</label>
                    <input type="email" class="form-control m-b-md" name="email" placeholder="Enter E-mail" value="<?php
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="password" class="form-control m-b-md" name="password" placeholder="Enter Password">
                </div>
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="password" class="form-control m-b-md" name="confirm_password" placeholder="Enter Confirm Password">
                </div>
                ...
                <?php if (isset($_SESSION['preg_match'])) : ?>
